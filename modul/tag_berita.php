...
$tag .='<div class="art-Berita-future" style="background-color:#FFFFFF;">
<ul id="newsslider1">';
	...
	while ($row=mysql_fetch_array($query)) {
        ...
        $tag .= '<li>
			...
			<p class="description">'.$isi.'<br /><a class="article-readmore" href="index.php?id=berita&kode='.$row['id'].'"> Selengkapnya</a></p>
		      </li>';
	}
$tag .="</ul></div>";
?>