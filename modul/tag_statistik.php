...
$tag .="<center><b>Kontak Admin</b></center>";
if ($email1 != "") {
  $tag  .='<div class="email-list"><i class="material-icons">email</i><span> '.$email1.'</span></div>';
}
if ($email2 != "") {
  $tag  .='<div class="email-list"><i class="material-icons">email</i><span> '.$email2.'</span></div>';
}
